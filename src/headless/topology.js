...
const TOPOLOGIES = Object.freeze({
  ...
  'luna-terra-trust-boundary': Object.freeze({
  ...
  'luna-generic-panel-terra': Object.freeze({
    label: 'Luna + three generic Luna critics + Terra review (benchmark only)',
    kind: 'convergent',
    peerMode: 'none',
    panelMode: 'generic',
    promptProfile: 'lean-standard',
    ...
    selectors: {
      coordinator: 'gpt-5.6-terra',
      workerA: 'gpt-5.6-luna',
      workerB: 'gpt-5.6-luna',
      reviewer: 'gpt-5.6-terra',
    },
  }),
  'luna-perspective-panel-terra': Object.freeze({
    label: 'Luna + perspective Luna review panel + Terra review (benchmark only)',
    kind: 'convergent',
    peerMode: 'none',
    panelMode: 'perspective',
    promptProfile: 'lean-standard',
    toolProfile: 'structured',
    benchmarkOnly: true,
    selectors: {
