...
test('usage tracker aggregates tokens and credits across persistent sessions', () => {
  ...
  usage.recordAssistantUsage('task1:a', { inputTokens: 100, outputTokens: 20, cost: 0.1 });
  usage.recordAssistantUsage('task1:b', { inputTokens: 50, outputTokens: 10, cost: 0.2 });
